      ...
      <nav class="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-5xl">
        <div class="glass px-6 py-3 rounded-full flex items-center justify-between shadow-2xl">
          ...
          <div class="hidden md:flex items-center gap-2">
            <a href="https://github.com/Yuval-Varke/RepoIntel" target="_blank" class="flex items-center gap-2 px-4 py-1.5 rounded-full border border-zinc-700 hover:border-primary/50 transition-all group cursor-pointer">
              <span class="material-symbols-outlined text-primary text-sm">star</span>
              <span class="text-[11px] font-mono tracking-wide text-zinc-400 group-hover:text-zinc-200 transition-colors">A star would be appreciated</span>
            </a>
