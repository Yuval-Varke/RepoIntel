      ...
      <nav class="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-5xl">
        <div class="glass px-6 py-3 rounded-full flex items-center justify-between shadow-2xl">
          ...
          <div class="hidden md:flex items-center gap-2">
            ...
            <svg class="w-12 h-10 text-zinc-400" viewBox="0 0 60 45" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
              <path d="M8 32 C4 24, 12 16, 18 22 C24 28, 14 34, 12 26 C10 18, 22 10, 48 16" />
              <path d="M43 11 L49 16 L42 20" />
            </svg>
