      ...
      <nav class="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-5xl">
        <div class="glass px-6 py-3 rounded-full flex items-center justify-between shadow-2xl">
          ...
          <div class="hidden md:flex items-center gap-2">
            <div class="flex items-center gap-2 px-4 py-1.5 rounded-full border border-zinc-700 transition-all">
              <span class="material-symbols-outlined pb-0.5 text-lg" style="color: #FFD700; font-variation-settings: 'FILL' 1;">star</span>
              <span class="text-[11px] font-mono tracking-wide text-zinc-400">A star would be appreciated !</span>
            </div>
            <svg class="w-14 h-14 text-zinc-400 -my-4 rotate-[30deg]" viewBox="0 0 70 65" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
              <path d="M10 50 C6 38, 18 20, 28 28 C38 36, 20 44, 20 32 C20 18, 35 8, 58 18" />
              <path d="M52 12 L59 18 L51 23" />
            </svg>
            <a class="flex items-center gap-2 px-4 py-2 bg-white text-black rounded-full text-sm font-semibold hover:opacity-90 transition-opacity" href="https://github.com/Yuval-Varke/RepoIntel" target="_blank">
